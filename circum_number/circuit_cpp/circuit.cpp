...
void HashLeftRight_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void HashLeftRight_2_run(uint ctx_index,Circom_CalcWit* ctx);
void MerkleTree_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MerkleTree_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
mySubcomponents[aux_create+i] = aux_cmp_num;
HashLeftRight_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 1773 ;
aux_cmp_num += 4;
}
}
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[15]); // line circom 25
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[9]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
...
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
HashLeftRight_2_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * ((Fr_toInt(&lvar[1]) * 2) + 1)) + 1)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
HashLeftRight_2_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 29
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[9]); // line circom 29
...
Fr_neq(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 39
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
Fr_div(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 40
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[3],&lvar[4]); // line circom 41
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Fr_lt(&expaux[0],&lvar[6],&lvar[5]); // line circom 42
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * (Fr_toInt(&lvar[2]) + 1)) + 0)]].signalStart + 0]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
HashLeftRight_2_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 45
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[6];
// load src
Fr_add(&expaux[0],&lvar[6],&circuitConstants[3]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[6],&lvar[5]); // line circom 42
...
PFrElement aux_dest = &lvar[4];
// load src
Fr_div(&expaux[0],&lvar[4],&circuitConstants[5]); // line circom 48
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_neq(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 39
...
MerkleTree_3_create(1,0,ctx,"main",0);
MerkleTree_3_run(0,ctx);
}
